...
class MyMidiTransformer(nn.Module):
    def __init__(self,
        ...
        assert vocabs.pitchs.text2id[tokens.PADDING_TOKEN_STR] == 0
        assert vocabs.durations.text2id[tokens.PADDING_TOKEN_STR] == 0
        assert vocabs.velocities.text2id[tokens.PADDING_TOKEN_STR] == 0
        assert vocabs.instruments.text2id[tokens.PADDING_TOKEN_STR] == 0
